                ...
                <form action="{{route('admin.photos.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" name="path">
                            <label class="custom-file-label" for="inputGroupFile01">Seleziona</label>
                        </div>
                        @error('path')
                            <small class="form-text">Errore</small>
                        @enderror
